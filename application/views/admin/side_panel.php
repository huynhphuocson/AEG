    ...
    <div class="side-panel-wrapper bg-white">
        ...
        <div class="tab-content">
            ...
            <div id="chat" role="tabpanel" class="tab-pane fade in active">
                <div class="chat">
                    <div class="chat-user-list scrollable ps-container ps-theme-default ps-active-y" data-ps-id="c0771eaf-279f-aa77-9887-7bef40af2510">
                        <div class="chat-section">
                            <h5 class="chat-title">Recent</h5>
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-1.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-2.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-3.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-6.jpg" alt="">
                                <div class="user-info">
                        ...
                        <div class="chat-section">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-4.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-5.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-10.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-11.jpg" alt="">
                                <div class="user-info">
                            ...
                            <a href="javascript:void(0);" class="chat-user chat-toggle">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-9.jpg" alt="">
                                <div class="user-info">
                        ...
                        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 523px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 331px;"></div></div></div>
            ...
            <div id="profile" role="tabpanel" class="tab-pane fade">
                <div class="profile scrollable ps-container ps-theme-default" data-ps-id="a3afe080-cc99-c2bc-89b1-a679c535d3d1">
                    <div class="pdd-horizon-20 pdd-top-20">
                        <div class="border bottom">
                            <div class="text-center mrg-top-20">
                                <div class="row">
                                    <div class="col-md-6 ml-auto mr-auto text-center">
                                        <img class="img-fluid border-radius-round" src="<?php echo public_url('admin/')?>assets/images/avatars/user-1.jpg" alt="">
                                    </div>
                                </div>
