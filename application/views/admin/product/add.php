                ...
                <fieldset>
                    <div class="card-block">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="form-1-1" placeholder="Name" name="product_name">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="form-1-1" placeholder="Name" name="product_code">
                                    </div>
                                    <div name="name_error" class="clear error">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Giá bán sử dụng để giao dịch" name="standard_cost" id="param_price" class="price_format">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="số tiền giảm giá" name="list_price" id="param_discount" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="form-1-1" placeholder="Name" name="quantity_per_unit">
                                    </div>
                                    <div name="name_error" class="clear error">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="form-1-1" placeholder="Name" name="minimum_reorder_quantity">
                                    </div>
                                    <div name="name_error" class="clear error">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="form-1-1" placeholder="Name" name="catalog">
                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        ...
                                                        <textarea id="summernote-usage" name="description"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
