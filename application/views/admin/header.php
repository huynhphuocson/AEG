                ...
                <div class="search-wrapper">
                    ...
                    <div class="pdd-vertical-10">
                        ...
                        <ul class="list-unstyled list-info">
                            <li>
                                <a href="">
                                    <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/img-1.jpg" alt="">
                                    <div class="info">
                            ...
                            <li>
                                <a href="">
                                    <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/img-2.jpg" alt="">
                                    <div class="info">
    ...
    <ul class="nav-right">
        <li class="user-profile dropdown">
            <a href="" class="dropdown-toggle" data-toggle="dropdown">
                <img class="profile-img img-fluid" src="<?php echo public_url('admin/')?>assets/images/user.jpg" alt="">
                <div class="user-info">
            ...
            <ul class="dropdown-menu">
                <li>
                    ...
                    <a href="<?php echo admin_url('admin/edit/').$admin_id; ?>">
        ...
        <li class="notifications dropdown">
            ...
            <ul class="dropdown-menu ">
                ...
                <li>
                    <ul class="list-info overflow-y-auto relative scrollable ps-container ps-theme-default ps-active-y" data-ps-id="358c383d-9ab6-fe53-3b07-ac0581a371cb">
                        <li>
                            <a href="">
                                <img class="thumb-img" src="<?php echo public_url('admin/')?>assets/images/avatars/thumb-5.jpg" alt="">
                                <div class="info">
                        ...
                        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 248px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 148px;"></div></div></ul>
                </li>
